  ...
  <div class="row justify-content-center">
    <div class="col-12 col-xl-10">
      <div class="row align-items-center my-4">
        <div class="col">
          <h2 class="h3 mb-0 page-title">Generate Pelunasan</h2>
          <p>generate pelunasan bulanan</p>
        </div>
      </div>
      <hr class="my-4">
      @if ($errors->any())
      ...
      <p class="mb-4">Kosongkan jika tidak ada Anggota yang ter kecuali, atau isikan nama Anggota sesuai daftar terkecuali</p>
      
      <form action={{ route('repayments.generated') }} method="POST" id="form-member" enctype="multipart/form-data">
        @csrf
        <div class="form-row">
         ...
         <div class="form-row">
           <div class="col-md-6">
            <small>Note: Anggota tercatat tidak akan tercatat pelunasan pada periode terpilih</small>
           </div>
