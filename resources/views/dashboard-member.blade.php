                  ...
                  <div class="card shadow border-0">
                     <div class="card-body">
                        <div class="row align-items-center">
                           ...
                           <div class="col pr-0">
                              <p class="small text-muted mb-0">Total Simpanan</p>
                              <span class="h3 mb-0">{{ number_format($total_saving??0,0,',','.')}}</span>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-md-6 col-xl-4 mb-4">
                  <div class="card shadow border-0">
                     <div class="card-body">
                        ...
                        <div class="col pr-0">
                           <p class="small text-muted mb-0">Total SHT</p>
                           <span class="h3 mb-0">{{ number_format($total_sht??0,0,',','.')}}</span>
                        </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-md-6 col-xl-4 mb-4">
                  <div class="card shadow border-0">
                     <div class="card-body">
                        ...
                        <div class="col pr-0">
                           <p class="small text-muted mb-0">Total Pinjaman</p>
                           <span class="h3 mb-0">{{ number_format($total_loan??0,0,',','.')}}</span>
                        </div>
                        </div>
                     </div>
                  </div>
