...
@section('title')
    <title>Kategori - Sistem Informasi Koperasi dan Usaha</title>
@endsection
@section('page_css')
      ...
      <form action="{{ route('categories.import') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body"> 
          <div class="form-group mb-3">
            <label for="categoryFile"> Format file harus sesuai template</label>
            <div class="custom-file">
              <input type="file" class="custom-file-input" id="categoryFile" name="file" accept=".xlsx,.xls" required>
  ...
  <div class="row justify-content-center">
    <div class="col-12">
      ...
      <div class="row align-items-center my-4">
          <div class="col">
              <a href="{{ route('categories.create') }}" class="btn mb-2 btn-primary">
          ...
          <div class="col-auto">
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" style="">
                <a class="dropdown-item" href="{{ route('categories.template')}}"><small>Download Template</small></a>
                    ...
                    <tr>
                      ...
                      <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item" href="{{ route('categories.edit', $ctg->id) }}">Edit</a>
                          <form action="{{ route('categories.destroy', $ctg->id) }}" method="POST" style="display: inline;" id="deleteForm">
                              @csrf
                              @method('DELETE')
...
<script>
    ...
    $('#btnDelete').on('click', function(e) {
      if (!confirm('Anda yakin ingin mengubah Aktivasi Kategori ini?')) {
        e.preventDefault();
      } else {
        $('#deleteForm').submit()
      }
    ...
    $('#categoryFile').on('change', function() {
